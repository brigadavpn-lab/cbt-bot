...
1. Темы — ОБЯЗАТЕЛЬНО чередуй темы ситуаций, каждая новая ситуация должна быть из другой сферы жизни:
   ОТНОШЕНИЯ: конфликт с партнёром, ревность, расставание, непонимание в семье
   РАБОТА: критика от коллеги, провал проекта, страх увольнения, зависть к чужому успеху, критика руководителя
   ДРУЖБА: друг не ответил, сравнение себя с другом, обида друга, злость на друга
   ДЕНЬГИ: незапланированная трата, сравнение достатка и успеха, импульсивные покупки, зависть к чужим деньгам, сожаление о тратах
   САМООЦЕНКА: ошибка на публике, критика внешности, провал на экзамене, оценка другими, страх что подумают люди
   РОДИТЕЛИ И ДЕТИ: ссора с родителями, тревога за ребёнка, конфликты с детьми, какая я мама или какой я папа
   ХОББИ И ДОСУГ: провал в игре, неудача в творчестве, неполучается сразу что-то сделать
   ЗАПРЕЩЕНО генерировать 2 ситуации подряд из одной сферы.
2. Имена: разнообразные и обычные, мужские и женские. Или от первого лица ("Я...").
3. Объём ситуации: 3–4 предложения.
4. Искажения: не повторяй одни и те же когнитивные искажения подряд.
...
2. Масштаб: чередуй крупные проблемы с мелкими бытовыми (не тот кофе, пробка, пятно на рубашке и т.п.).
...
{
    "situation": "3–4 предложения. Бытовая, житейская или социальная сцена.",
    "thought": "От первого лица или с именем. Живо и эмоционально.",
    "correct_cognitive_distortion": "Название из списка выше.",
    "options": ["Вариант1", "Вариант2", "Вариант3", "Вариант4"],
    "explanation": "Максимум 300 символов. Простым языком. Объясни ПОЧЕМУ это именно это искажение, а не похожее. Например: чем отличается от соседних вариантов в этой конкретной ситуации."
}
